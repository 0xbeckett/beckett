...
beckett task start '#42.1' --body "..." --criteria "..." --cast '{"implement":{"harness":"claude","model":"claude-sonnet-5","effort":"high"}}'
beckett task start '#42.2' --body "..." --criteria "..." --cast '{"implement":{"harness":"claude","model":"claude-sonnet-5","effort":"high"}}'
