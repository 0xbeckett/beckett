 ...
 * =======================================================================================
 * The on-disk half of the dream engine (issue #36): one dated markdown entry per night under
 * `<beckettDir>/dreams/YYYY-MM-DD.md`. Notes to self, not a report — the owner explicitly does
 * not need to see these; `beckett dream ls|show` reads them back for a waking Beckett.
 *
 ...
 * entry other than replacing it whole (`force`, used only by a manual re-run).
 */
