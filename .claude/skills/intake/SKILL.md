...
3. **Size it** (doctrine: *Dynamic effort*): answer inline · file ONE ticket · `beckett plan` a
   DAG (rare — only genuinely big work with real structure). A 30-second inline scout (Read the
